...
(function () {
  ...
  var onWizardCoatClick = function () {
    var randomColor = window.getRandomElement(window.constants.WIZARD_COAT_COLOR);
    setupWizardCoat.style.fill = randomColor;
    inputWizardCoat.value = randomColor;
  };

  var onWizardEyesClick = function () {
    var randomColor = window.getRandomElement(window.constants.WIZARD_EYES_COLOR);
    setupWizardEyes.style.fill = randomColor;
    inputWizardEyes.value = randomColor;
  };

  var onWizardFireballClick = function () {
    var randomColor = window.getRandomElement(window.constants.WIZARD_FIREBALL_COLOR);
